...
root.geometry("700x800")  # размеры окна
...
hangman_canvas.pack(pady=20)  # размещаем с отступом сверху
...
new_game_btn = tk.Button(
    ...
    font=("Arial", 14),
    bg="#dda0dd",  # цвет фона
    command=new_game  # действие при нажатии
)
new_game_btn.pack(pady=10)  # размещаем с отступом
...
restart_btn = tk.Button(
    ...
    font=("Arial", 14),
    bg="#9370db",  # цвет фона
    command=restart_game  # действие при нажатии
)
restart_btn.pack(pady=10)  # размещаем с отступом
